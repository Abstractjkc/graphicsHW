...
private:
	...
	float angle;
	DirectX::XMFLOAT3 viewRot;	//相机旋转过的角度
	DirectX::XMFLOAT3 viewPos;	//相机的位置
	bool lightSwitch[3];	// 三个光源开关
	enum LightMode
	{
		DirLightMode = 0,	//平行光源模式
		PointLightMode = 1,	//点光源模式
		SpotLightMode = 2,	//聚光灯模式
	};
};
